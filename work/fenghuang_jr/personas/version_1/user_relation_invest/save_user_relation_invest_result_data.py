...
class SaveUserRelationInvestResultData:
    def __init__(self):
        self.input_user_relation_invest_result_sql_path = read_conf.ReadConf().get_options("path_user_relation_invest", "input_user_relation_invest_result_sql_path")
    ...
    def get_result_data(self, is_success):
        ...
        try:
            ...
            os_v = hive_command_method.hive_command(str(param), self.input_user_relation_invest_result_sql_path)
            if os_v == 0:
                is_success.append(1)
...
if __name__ == '__main__':
    test = SaveUserRelationInvestResultData()
