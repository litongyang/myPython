insert overwrite table app.app_user_predict_first_invest_account_feature_2017_full
select
	t.user_id,
	t1.invest_cnt_7,
	t1.invest_sum_7,
...
(
	...
	where
		first_invest_tm>'2016-12-31'
		and first_invest_tm < '2018-01-01'
...
(
	...
	from
		(
			...
			where
			    dt=edw_day_amount(-1)
			    and first_invest_tm<edw_day_amount(-8)
			    and first_invest_tm is not null
		) as a
	left outer join
		(
...
(
	...
	from
		(
			...
			where
			    dt=edw_day_amount(-1)
			    and first_invest_tm<edw_day_amount(-15)
			    and first_invest_tm is not null
		) as a
	left outer join
		(
...
(
	...
	from
		(
			...
			where
			    dt=edw_day_amount(-1)
			    and first_invest_tm<edw_day_amount(-31)
			    and first_invest_tm is not null
		) as a
	left outer join
		(
...
(
	...
	from
		(
			...
			where
			    dt=edw_day_amount(-1)
			    and first_invest_tm<edw_day_amount(-61)
			    and first_invest_tm is not null
		) as a
	left outer join
		(
...
(
	...
	from
		(
			...
			where
			    dt=edw_day_amount(-1)
			    and first_invest_tm<edw_day_amount(-91)
			    and first_invest_tm is not null
		) as a
	left outer join
		(
...
(
	...
	from
		(
			...
			where
			    dt=edw_day_amount(-1)
			    and first_invest_tm<edw_day_amount(-121)
			    and first_invest_tm is not null
		) as a
	left outer join
		(
