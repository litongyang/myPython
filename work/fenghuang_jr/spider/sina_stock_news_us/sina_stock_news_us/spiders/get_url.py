...
class GetUrl:
    def __init__(self):
        ...
        self.company_news_url_head = 'http://biz.finance.sina.com.cn/usstock/usstock_news.php?pageIndex=1&symbol='
        self.company_news_url_tail = '&type=1'
        self.company_news_url_head_hk = 'http://stock.finance.sina.com.cn/hkstock/news/'
        self.company_news_url_tail_hk = '.html'
