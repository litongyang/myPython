...
class MacroData:
    def __init__(self):
        ...
        self.month_count = 125
        self.url_set = {}
        self.data_init_class = dataInit.DataInit()

        self.monthNum = "LAST125"
        # self.endTime = "201512"
        ...
        self.req_header = {'User-Agent': 'Mozilla/5.0 (Windows NT 6.3; WOW64; rv:42.0) Gecko/20100101 Firefox/42.0',
                           ...
                           'Cookie': '_gscu_1771678062=64257026rn0msb85; _gscs_1771678062=648345496uejth13|pv:2; _gscbrs_1771678062=1; JSESSIONID=04041296675CBF3ADC161BEC8FD654AA; u=6; experience=show',
    ...
    def create_table(self):
        ...
        for m in range(int(self.month_now) -2, 0, -1):
